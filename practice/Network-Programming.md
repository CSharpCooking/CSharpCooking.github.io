...
4. Разработать программу для авторизации на сайте и вывода списка товаров корзины пользователя. В качестве сайта можно выбрать [bookland.com](http://www.bookland.com).       
