...
2. Развить решение первого задания, обеспечив передачу данных между клиентом и сервером по защищенному каналу с использованием криптографического алгоритма AES.
3. Разработать программу для авторизации на сайте и вывода списка товаров корзины пользователя. В качестве сайта можно выбрать [bookland.com](http://www.bookland.com).
4. Разработать программу для сохранения изображение PNG из [https://academia-library.ru/reader/?id=143477&page=1](https://academia-library.ru/reader/?id=143477&page=1).      

## Рекомендации

* Для выполнения практикума рекомендуется руководствоваться источником:
  Албахари Д. C# 7.0. Справочник. Полное описание языка / Албахари Д., Албахари Б. // Пер. с англ. – Москва: Альфа-Книга. – 2018. (См. главы 16 "Взаимодействие с сетью", 21 "Безопасность", 26 "Регулярные выражения".)
