# Практикум по составлению запросов на языках SQL и LINQ [↩︎](/sources)
...
В качестве примера рассмотрим решение к задаче №57 второго уровня сложности, взятого из [сайта](https://www.sql-ex.ru/learn_exercises.php).
...
- [Пример требований к оформлению отчета по выполненному практикуму (курсовой работы)](https://csharpcooking.github.io/practice/LINQCourseWorkRequirements.zip). 