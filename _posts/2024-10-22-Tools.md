...
- [ILGPU](https://ilgpu.net) – компилятор для реализации GPU-вычислений на .NET-языках.
...
- [Uninstall Tool](https://crystalidea.com/uninstall-tool) – утилита для удаление программ вместе с остаточными файлами, папками и записями реестра, которые стандартный деинсталлятор Windows часто оставляет.
- [Geek Uninstaller](https://geekuninstaller.com) – портативная утилита для удаления программ в Windows.
- [CPU-Z](https://www.cpuid.com/softwares/cpu-z.html) – утилита для отображения технической информации о компьютере.
- [FileZilla](https://filezilla-project.org/download.php?show_all=1) – FTP-менеджер.
