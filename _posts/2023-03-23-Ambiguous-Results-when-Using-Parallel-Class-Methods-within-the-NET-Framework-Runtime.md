...
Применим данный метод на практике, чтобы просуммировать квадратные корни чисел от 1 до <p>10<sup>7</sup></p>
...
![image-20230322185503020](C:\Users\landw\AppData\Roaming\Typora\typora-user-images\image-20230322185503020.png)
...
| Диапазон                 | (10-324-10-308)     | (10-28-10-28)                                                |
