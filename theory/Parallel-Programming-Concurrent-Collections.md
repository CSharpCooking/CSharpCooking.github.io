...
1. Реализуйте *стек* производителей/потребителей с максимальной степенью параллелизма равную 2. 
2. Задействуйте при работе со стеком обобщенный метод `Enqueue<TResult>`.

## Методические указания по выполнению

- Для выполнения задания рекомендуется ознакомиться с пунктом "Параллельные коллекции" 23-й главы «Параллельное программирование» книги [Албахари Д. C# 7.0. Справочник. Полное описание языка](https://csharpcooking.github.io/theory/AlbahariCSharp7.zip).
